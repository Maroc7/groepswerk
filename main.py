...
#actions projects:
C_ACTION_MENU_PROJECT = 44
C_ACTION_MAKE_PROJECT = 41
C_ACTION_SHOW_PROJECT = 42

C_ACTION_RETURN = 0
C_STOP = 99
C_ACTIONS = [C_ACTION_MAKE_TASK,C_ACTION_MAKE_TASK,C_ACTION_DELETE_TASK,C_ACTION_SHOW_USER, C_ACTION_DELETE_USER,C_ACTION_RETURN,C_ACTION_MENU_TASK,C_ACTION_MENU_PROJECT,C_ACTION_MAKE_PROJECT,C_ACTION_SHOW_PROJECT, C_ACTION_MENU_PROJECT, C_ACTION_MAKE_PROJECT, C_ACTION_SHOW_PROJECT]
